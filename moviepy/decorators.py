...
def audio_video_fx(f):
    """
    Kennzeichnet eine Funktion als Audio- oder Videoeffekt.
    In MoviePy wird das z.B. genutzt, um FX dynamisch zu erkennen.
    """
    f.audio_video_fx = True
    return f
